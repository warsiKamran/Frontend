                ...
                {loading || !stats ? <Loader color='purple.500'/> : (
                    <Box boxSizing="border-box" py="16" px={["4", "0"]}>
                        ...
                        <Stack direction={["column", "row"]} minH={"24"} justifyContent={"space-evenly"}>
                            ...
                            <Databox title="Subscriptions" qty={subCount} qtyPercentage={subPercentage} profit={subProfit} />
                        </Stack>
                        ...
                        <Grid templateColumns={["1fr","2fr 1fr"]}>
                            <Box p={"4"}>
                                ...
                                <Box>
                                    ...
                                    <Bar profit={subProfit} title="Subscriptions" value={subPercentage}/>
                                </Box>
                            </Box>
                            ...
                            <Box p={["0","16"]} boxSizing="border-box" py={"4"}>
                                ...
                                />
                                {/* DOUGHNUT GRAPH HERE */}
                                <DoughnutChart users={[subCount, usersCount-subCount]}/>
                            </Box>
                    </Grid>
                </Box>
                )}
